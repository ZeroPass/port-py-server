...
protoChallenge: Final = Table('proto_challenge', metadata,
    ...
    Column('uid'      , UserIdSqlType()         , nullable=False  , unique=True, index=True ), # TODO: make uid foreign key of account.uid when retrieving challenge is restricted to registered accounts
...
sod: Final = Table('sod', metadata,
    ...
    Column('dg4Hash'  , VARBINARY(256)  , nullable=True , unique=False, index=True                        ),
    Column('dg5Hash'  , VARBINARY(256)  , nullable=True , unique=False, index=True                        ),
    Column('dg6Hash'  , VARBINARY(256)  , nullable=True , unique=False, index=True                        ),
    Column('dg7Hash'  , VARBINARY(256)  , nullable=True , unique=False, index=True                        ),
    Column('dg8Hash'  , VARBINARY(256)  , nullable=True , unique=False, index=True                        ),
    Column('dg9Hash'  , VARBINARY(256)  , nullable=True , unique=False, index=True                        ),
    Column('dg10Hash'  , VARBINARY(256) , nullable=True , unique=False, index=True                        ),
    Column('dg11Hash'  , VARBINARY(256) , nullable=True , unique=False, index=True                        ),
    Column('dg12Hash'  , VARBINARY(256) , nullable=True , unique=False, index=True                        ),
    Column('dg13Hash'  , VARBINARY(256) , nullable=True , unique=False, index=True                        ),
    Column('dg14Hash'  , VARBINARY(256) , nullable=True , unique=False, index=True                        ),
    Column('dg15Hash'  , VARBINARY(256) , nullable=True , unique=False, index=True                        ),
    Column('dg16Hash'  , VARBINARY(256) , nullable=True , unique=False, index=True                        ),
)
mapper(SodTrack, sod)
